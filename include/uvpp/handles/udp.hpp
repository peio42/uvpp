...
namespace uv {
  ...
  public:
    ...
    udp_send_many_view view() noexcept {
      return udp_send_many_view{std::span<uv_buf_t *>{buffer_arrays_},
                                std::span<unsigned int>{buffer_counts_},
                                std::span<sockaddr *>{addresses_}};
    }
